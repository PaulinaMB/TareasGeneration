...
/******PROTECTED: Se manejarán dentro del package*/

public class Employeee {
	//no vamos a poner metodo main hasta que instanciemos lo objetos
	//1. Atributos o propiedades
	/*VAMOS A ENCAPSULAR:
	 * pROPIEDADES O ATRIPUTOS: Utilizando un modificador private, no se puede dar acceso a cualquier parte del codigo a que acceda a estos. nadie accede a ellos*/
	...
	/*2. ENCAPSULAR EL MÉTODO CONSTRUCTOR. Será publico porque los objetos se construiran en otras clases y para poder acceder al constructor es necesario que sea púbblico*/
	public Employeee(String nombre, String apellido, int id, double salario, String puesto){
	...
	/*ENCAPSULAR MÉTODOS DE COMPORTAMIENTO. Serán de tipo public*/
		...
		/*	qué pasa si hago privado el getter? En el main marcará error ya que al privarlo solo se puede acceder a manera local, o sea en esta clase, no en la main. */
		public String getNombre() {
			return nombre;
		}
