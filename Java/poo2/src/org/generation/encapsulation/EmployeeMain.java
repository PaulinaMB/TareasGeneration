...
//Aquí vivirán los objetos así que establecer método main
	public static void main(String[] args) {
		...
		/*UTLIZANDO LA PROP DEL OBJ PODIA ACCEDER A LA INFO DEL PUESTO Y SALARIO, PERO EN MOMENTO EN EL QUE SE CONVIRTIO EN PRIVDAO, SE PERDIÓ EL ACCESO. ¿QUÉ PDEMOS HACER?
		 * Necesitamos traer la información mediante getters ya que los atributos de convirtieron en privados*/
