...
public class EjercicioDatos {
	...
	public static void main(String[] args) {
		...
		/*
		 * Casteo: el tipo de dato cambia a otro tipo. 
		 * OBS en este caso el casteo se guardó en otra variable
		 * */
		
		int nombreCambio = Integer.parseInt(costoBoleto);
		double zonaCambio = Double.parseDouble(zonaBoleto); //el tipo de dato al que vamos a cambiar se escribe con mayúscula
		 ...
		 * byte = Byte
		 * long = Long*/
		/*Los datos primitivos pertenecen a 
		 * clases específicas, 
		 * en este caso, clases Wrapper
		 * */
		...
		/*Hacer variables de:
		 ...
		 Bebidas = $35.50	 */
			float precioEntrada = 75.50f;
			double precioPalomitas = 89.70;
			float precioBebida = 35.5f;
		...
		float totalEntrada = (personasDentro * precioEntrada);
		double totalPalomitas = personasDentro * precioPalomitas;
		float totalBebidas = personasDentro * precioBebida;
