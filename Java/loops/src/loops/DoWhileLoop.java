...
public class DoWhileLoop {
	public static void main(String[] args) {
		 ...
		 */
		System.out.println("Bienvenido al cajero City Generation, elija algunas de nuestras opciones disponibles.");
		...
		do {
			...
			default: 
				System.out.println("Por favor elija una opcion valida de nuestro menu");
			}
		}while(opcion != 4);
