...
public class SistemaEscolar {
	public static void main(String[] args) {
		...
		} while(!(nombreEstudiante.equals("Salir") || nombreEstudiante.equals("salir"))); //Siempre que NO se escriba "Salir", el loop se sigue ejecutando //equals te compara cadenas de texto
		//Mostrar lista de estudiantes (for-each)
		...
		/*
		 * Modificar nuestro programa para permitir que salga con las palabras 'Salir' o 'salir'.
